          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownLanguage">
            <li>
              <a class="dropdown-item" href="{{ route('setLocale', 'en') }}">
                <img src="http://127.0.0.1:8000/assets/images/us-flag.png" alt="US Flag" class="language-icon">
                @lang('nav.en')
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="{{ route('setLocale', 'zh') }}">
                <img src="http://127.0.0.1:8000/assets/images/china-flag.png" alt="China Flag" class="language-icon">
                @lang('nav.zh')
              </a>
            </li>
          </ul>
